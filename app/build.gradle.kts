...
android {
    namespace = "com.example.grading_management"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.grading_management"
        minSdk = 25
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("com.google.android.material:material:1.4.0")
        ...
        implementation ("androidx.core:core-ktx:1.10.0") // Optional for Kotlin extensions
